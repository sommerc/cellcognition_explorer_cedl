...
parser.add_argument('--im_size', '-is', type=int, help='Size of the squared, cropped input images (in pixel)', default=40)    
...
train_parser.add_argument('--epochs', '-e' , type=int, help='Number of training epochs', default=10)
...
class BaseReader(object):
    ...
    def get_output_file_name(self):
        return '%s_galleries_%s_40x40_%dk.h5' % (self.name, self.pargs.neg_condition, self.pargs.nsamples / 1000)
...
class StandardOutputWriter(object):
    ...
    def __init__(self, filename):
        ...
        self.gallery = self.create_writer("gallery", self.data_grp, self.GALLERY_DTYPE, kind="a", shape=(40,40,1,'x'), grow_dim=3)
